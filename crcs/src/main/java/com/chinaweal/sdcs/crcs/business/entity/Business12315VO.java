...
public class Business12315VO {
     ...
     * 登记编号
     */
    @Excel(name = "登记编号", orderNum = "1", width = 20)
...
//    @Excel(name = "类型", orderNum = "2", width = 20)
     ...
     * 当前环节
     */
    @Excel(name = "当前环节", orderNum = "3", width = 15)
     ...
     * 登记时间
     */
    @Excel(name = "登记时间", orderNum = "4", width = 20, format = "yyyy-MM-dd HH:mm:ss ")
     ...
     * 提供方
     */
    @Excel(name = "提供方", orderNum = "5", width = 15)
    private String complainant;

    /**
     * 涉及主体名称
     */
    @Excel(name = "涉及主体名称", orderNum = "6", width = 20)
     ...
     * 登记内容
     */
    @Excel(name = "登记内容", orderNum = "7", width = 30)
     ...
     * 处理部门
     */
    @Excel(name = "处理部门", orderNum = "8", width = 20)
     ...
     * 到期时间
     */
//    @Excel(name = "到期时间", orderNum = "9", width = 20, format = "yyyy-MM-dd HH:mm:ss ")
    private Date expiredate;

    /**
     * 标题
     */
//    @Excel(name = "标题", orderNum = "3", width = 25)
...
//    @Excel(name = "诉求来源", orderNum = "6", width = 15)
     ...
     * 来电号码
     */
    @Excel(name = "来电号码", orderNum = "10", width = 20)
