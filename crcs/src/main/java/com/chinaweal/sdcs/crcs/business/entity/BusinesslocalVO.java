...
//    @Excel(name = "业务类型", orderNum = "1", width = 20)
     ...
     * 工单分类
     */
//    @Excel(name = "工单分类", orderNum = "2", width = 20)
    private String focus;

    /**
     * 表单号
     */
//    @Excel(name = "表单号", orderNum = "1", width = 20)
    private String serialnum;

    /**
     * 工单号
     */
    @Excel(name = "工单号", orderNum = "0", width = 20)
     ...
     * 标题
     */
//    @Excel(name = "标题", orderNum = "4", width = 25)
     ...
     * 工单状态/当前环节
     */
//    @Excel(name = "当前环节", orderNum = "5", width = 15)
     ...
     * 业务分类
     */
//    @Excel(name = "业务分类", orderNum = "6", width = 15)
     ...
     * 办理时间
     */
    @Excel(name = "办理时间", orderNum = "8", width = 20, format = "yyyy-MM-dd HH:mm:ss ")
...
//    @Excel(name = "到期时间", orderNum = "8", width = 20, format = "yyyy-MM-dd HH:mm:ss ")
     ...
     * 诉求内容
     */
//    @Excel(name = "诉求内容", orderNum = "4", width = 30)
...
//    @Excel(name = "诉求来源", orderNum = "6", width = 15)
     ...
     * 来电号码
     */
//    @Excel(name = "来电号码", orderNum = "7", width = 20)
    private String phone;

    /**
     * 来电人姓名
     */
   @Excel(name = "投诉/举报人姓名", orderNum = "3", width = 15)
     ...
     * 关键字
     */
    @Excel(name = "关键字", orderNum = "12", width = 15)
    private String keyword;

    /**
     * 涉及主体名称
     */
    @Excel(name = "被投诉人名称", orderNum = "5", width = 20)
    private String complainanted;

    /**
     * 处理部门
     */
    @Excel(name = "处理部门", orderNum = "6", width = 20)
...
//    @Excel(name = "是否诉转案", orderNum = "21", width = 10)
     ...
     * 业务性质
     */
    @Excel(name = "业务性质", orderNum = "1", width = 10)
    ...
    //来函单位
    @Excel(name = "来函单位", orderNum = "2", width = 20)
    private String incomingcommpany;

    //投诉/举报人
    //@Excel(name = "投诉/举报人", orderNum = "3", width = 20)
    private String rqstperson;
    //联系电话
    //@Excel(name = "联系电话", orderNum = "4", width = 20)
    private String rqstnumber;
    //被投诉举报单位
//    @Excel(name = "被投诉举报单位", orderNum = "5", width = 20)
    private String subjectname;
    //处理单位
//    @Excel(name = "处理单位", orderNum = "6", width = 20)
    private String dealcompany;
    //商品服务类型
    @Excel(name = "商品服务类型", orderNum = "9", width = 20)
    private String servicetype;

    @Excel(name = "来电号码", orderNum = "4", width = 20)
    private String serialTel;
    @Excel(name = "是否网购", orderNum = "10", width = 20)
    private String buyininternet;
    @Excel(name = "是否职投", orderNum = "11", width = 20)
    private String isprofessional;
    @Excel(name = "是否立案", orderNum = "13", width = 20)
    private String isregistercase;
    @Excel(name = "调解结果", orderNum = "14", width = 20)
    private String resultsofmediation;
    @Excel(name = "办结时间", orderNum = "15", width = 20)
    ...
    public String getSerialTel() {
        return serialTel;
    }

    public void setSerialTel(String serialTel) {
        this.serialTel = serialTel;
    }

    public String getBuyininternet() {
        return buyininternet;
    }

    public void setBuyininternet(String buyininternet) {
        this.buyininternet = buyininternet;
    }
