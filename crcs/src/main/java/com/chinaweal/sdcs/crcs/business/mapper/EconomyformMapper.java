 ...
 * @since 2019-08-18
 */
public interface EconomyformMapper extends BaseMapper<Economyform> {
    ...
    IPage<Economyform> searchEconomyformList(Page<Economyform> page, @Param("map")Map<String, Object> requestMap);
}
