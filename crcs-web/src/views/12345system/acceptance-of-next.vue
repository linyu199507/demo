            ...
            <el-tab-pane :label="formTypeStr" name="tabMainContent">
                ...
                <el-collapse v-model="collapseValues" class="accordion" style="margin: 15px auto;">
                    ...
                    <el-collapse-item name="orderInfo">
                        ...
                        <el-row>
                            <el-col :xs="24" :sm="12" :md="8" :lg="8" class="item_col">
                                <el-col :span="8" class="label">接听坐席：</el-col>
                                <el-col :span="8">{{customerinfo.seatsname}}</el-col>
                            </el-col>
                            <el-col :xs="24" :sm="12" :md="8" :lg="8" class="item_col">
            ...
            <el-tab-pane label="处理反馈" name="tabFeedback" v-if="tabActionName==='tabFeedback'">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <el-col style="text-align: center;width: 100%;">
                                <el-button type="primary" @click="openRegionAudit" :loading="submitLoading">送区局消保科处理
                                </el-button>
                ...
                >
                        ...
                        <el-col :xs="24" :sm="12" :md="8" :lg="24">
                            <el-form-item label="咨询相关附件" class="bt" style="float: left">
                                ...
                                >
                                    <div slot="tip" class="el-upload__tip">已选取的文件，等待上传</div>
                                    <el-button slot="trigger" size="small" type="primary">选取文件</el-button>
                                    <el-button size="small" type="success" @click="submitUpload('uploadConsul')">确认上传
                                    </el-button>
                                </el-upload>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-form-item
                            ...
                            v-if="user.unitID != 'da00ef72-5b56-4f5b-88c2-4b038a7f41a0'"
                    >
                        <el-button type="primary" @click="openRegionAudit">送区局处理</el-button>
...
<script>
    ...
    import {getMaterialLists, uploadFile,sendMessage,getSMSPerson,deleteUploadFile} from "../../api/api";
        ...
        methods: {
            ...
            openRegionAudit() {
                    ...
                    if ("complaintmodule" === this.formType) {
                        ...
                        // this.$refs["caseprocesformG"].validate(valid => (validation = valid && validation));
                    }
                ...
                if(this.user.unitID == 'da00ef72-5b56-4f5b-88c2-4b038a7f41a0'){
                    ...
                    if ("commommodule" === this.formType) {
                        ...
                        if (
                            ...
                            this.complaintform.businesstype = this.Businesstype1;
                        }
                    ...
                    nextWork(params)
                        .then(data => {
                            if (data.code === 0) {
                                ...
                                // this.$router.push({path:"/wddb/12345db",params});
                            } else {
                                this.errorAlert();
                            }
                            this.submitLoading = false;
                    ...
                    .then(({code, data}) => {
                        ...
                        if (data.caseprocesform != null) {
                            ...
                            if(this.caseprocesform.transferreddate != null && this.caseprocesform.transferreddate != ""){
                                this.caseprocesform.transferreddate = new Date(this.caseprocesform.transferreddate)
                            }
                        }
