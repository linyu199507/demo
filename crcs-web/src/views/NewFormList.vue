...
<template>
    <section class="db_12345">
        ...
        <div class="handle_btn">
            ...
            <el-button type="danger" v-if="user.unitID == 'da00ef72-5b56-4f5b-88c2-4b038a7f41a0'" @click="handleDel"
                       size="small" icon="delete">删除
            </el-button>
        </div>
        <!--列表-->
        <el-table
        ...
        >
            ...
            <el-table-column
                    ...
                    :formatter="formtypes"
            ></el-table-column>
            <el-table-column prop="serialnum" label="表单号" min-width="14%" align="center"></el-table-column>
            <el-table-column
                    prop="rqsttitle"
                    label="工单标题"
                    min-width="17%"
