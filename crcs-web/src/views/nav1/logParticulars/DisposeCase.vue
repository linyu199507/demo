<template>
    <section class="disposeCase">
        ...
        <el-tabs type="border-card" style="width: 96%;margin: 0 auto;" @tab-click="flow" v-model="aictabs">
            ...
            <el-tab-pane label="立案处理" v-if="assign">
                <el-collapse v-model="registrationActiveNames" class="accordion">
                    <el-collapse-item name="1">
                        <div slot="title" @click.stop="">
                            <el-row class="el-accordion">
                        ...
                        <el-form :model="comeconomicmodule" label-width="180px" ref="comeconomicmodule">
                            <el-row>
                                <el-col :xs="24" :sm="24" :md="12" :lg="12">
                                    <el-form-item label="涉及主体：" class="bt">
                                ...
                                <el-col :xs="24" :sm="24" :md="12" :lg="12">
                                    <el-form-item label="属实情况：" class="bt">
                                        <el-select
                                                placeholder="请选择"
                                                class="input-text">
                                            <el-option label="属实" value="complain"></el-option>
                                            <el-option label="不属实" value="consult"></el-option>
                                            <el-option label="待定" value="indeterminate"></el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="24" :md="24" :lg="24">
                                    <el-form-item label="调查情况:" class="bt">
                                        <el-input
                                                ...
                                                v-model="comeconomicmodule.text">
                                        </el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                    ...
                    <el-collapse-item name="2">
                        ...
                        <el-form :model="comeconomicmodule" label-width="180px" ref="comeconomicmodule">
                            <el-row>
                                <el-col :xs="24" :sm="24" :md="12" :lg="12">
                                    <el-form-item label="是否立案：" class="bt">
                                        <el-select
                                                placeholder="请选择"
                                                class="input-text">
                                            <el-option label="立案" value="complain"></el-option>
                                            <el-option label="不立案" value="consult"></el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                    ...
                    <el-row style="margin: 20px auto;width: 96%;">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item label="延时单位：" prop="department" required>
                                <el-select v-model="nextStepForm.department" placeholder="请选择" prop="department" style="width: 220px;">
                                    <el-option
                                            v-for="item in dept"
                                            :key="item.value"
                                            :label="item.label"
