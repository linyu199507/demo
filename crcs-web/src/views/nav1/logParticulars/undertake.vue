<template>
    <section class="undertake">
        <el-row style="margin-top: 0;margin-bottom: 5px">
            <el-col>
                <el-steps :active="3" align-center center space="22%">
        ...
        <el-tabs type="border-card" style="width: 96%;margin: 0 auto;" @tab-click="flow" v-model="aictabs">
                                    ...
                                    <el-collapse-item name="1">
                                        ...
                                        <el-form :model="complaintform" label-width="220px" ref="complaintform">
                                            <el-row>
                                                <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                                    <el-col :span="8" class="bt">登记单编号：</el-col>
                                                    <el-col :span="14" class="st">{{complaintform.number}}</el-col>
                                                </el-col>
                ...
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    ...
                    <el-row style="margin: 20px 0;">
                        <el-col style="text-align: center;">
                            <el-button type="primary" @click="$router.push('/wddb/12345db/gdsh')">
                                分派下级
                            </el-button>
                        </el-col>
                    </el-row>
            ...
            <el-tab-pane label="结果处理" v-if="coupleBack">
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    <table style="width: 96%;border-color: #fbfdff;margin: 0 auto;" cellspacing="0" cellpadding="0" border>
                        <tr style="width: 100%;height: 65px;">
                            <td  style="width: 20%;height:120px;text-align: center;font-weight: bold;"><span style="color: #e64242">*</span>处理结果：</td>
                            <td  style="width: 80%">
                                <input style="width: 99.5%;height: 120px;" placeholder="请输入内容">
                            </td>
                        </tr>
                    ...
                    <el-row style="margin: 20px 0;">
                        <el-col style="text-align: center;">
                            ...
                            <el-button type="primary" @click="toAccept(3)"><!--@click="$router.push({path:'/wddb/tsldb/ldsh',query:{id:tasklist.id,caseguid:tasklist.caseguid}})"-->
                                送领导审核
                            </el-button>
                        </el-col>
                    </el-row>
            ...
            <el-tab-pane label="申请延时" v-if="postpone">
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    <el-row style="margin: 20px auto;width: 96%;">
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item label="延期时限:">
                                <el-date-picker
                                        style="width: 200px;"
                                        v-model="nextStepForm.registrarDate"
                                        type="date"
                                        class="input-text"
                                        placeholder="选择日期">
                                </el-date-picker>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item label="延时单位：" prop="department" required>
                                <el-select v-model="nextStepForm.department1" placeholder="请选择" prop="department" style="width: 220px;">
                                    <el-option
                                            v-for="item in dept"
                                            :key="item.value"
                                            :label="item.label"
                    ...
                    <table style="width: 96%;border-color: #fbfdff;margin: 0 auto;" cellspacing="0" cellpadding="0" border>
                        <tr style="width: 100%;height: 65px;">
                            <td  style="width: 20%;height:120px;text-align: center;font-weight: bold;"><span style="color: #e64242">*</span>延时原因：</td>
                            <td  style="width: 80%">
                                <input style="width: 99.5%;height: 120px;" placeholder="请输入内容">
                            </td>
                        </tr>
                    ...
                    <el-row style="margin: 20px 0;">
                        <el-col style="text-align: center;">
                            <el-button type="primary" @click="$router.push({path:'/wddb/tsldb/ysqsh',query:{id:tasklist.id,caseguid:tasklist.caseguid}})">
                                申请延时
                            </el-button>
                        </el-col>
                    </el-row>
            ...
            <el-tab-pane label="送领导审核" v-if="choose">
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    <el-row style="margin: 20px auto;width: 96%;">
                        <el-col :xs="24" :sm="24" :md="24" :lg="12">
                            <el-form-item label="选择领导：" prop="opinion">
                                <el-select v-model="nextStepForm.opinion1" placeholder="请选择" style="width: 180px;">
                                    <el-option
                                            v-for="item in reasonBack"
                                            :key="item.value"
                   ...
                   <!-- <table style="width: 96%;border-color: #fbfdff;margin: 0 auto;" cellspacing="0" cellpadding="0" border>
                    ...
                    <el-row style="margin: 20px 0;">
                        <el-col style="text-align: center;">
                            <el-button type="primary" @click="$router.push({path:'/wddb/tsldb/ldsh',query:{id:tasklist.id,caseguid:tasklist.caseguid}})">
                                确认
                            </el-button>
                        </el-col>
                    </el-row>
        ...
        <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto" v-show="flows">
            <el-col style="text-align: center;">
                ...
                <el-button type="primary" @click="toAccept(4)">
                    退回
                </el-button>
            </el-col>
        </el-form>
