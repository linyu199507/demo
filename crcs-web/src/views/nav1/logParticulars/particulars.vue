<template>
    <section class="particulars" style="margin: 20px 0">
                            ...
                            <el-row>
                                ...
                                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                                    <el-form-item label="工单分类:" class="bt">
                                        <el-select v-model="basicForm.word" placeholder="请输入" class="input-text" @change="onChange">
                                            <el-option label="普通" value="complain"></el-option>
                                            <el-option label="特殊" value="special"></el-option>
                                            <el-option label="特派" value="consult"></el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="18" v-show="special">
                                    <el-form-item class="bt">
                                        <el-checkbox-group v-model="checkList">
                                            <el-checkbox label="督办"></el-checkbox>
                                            <el-checkbox label="催办"></el-checkbox>
                                            <el-checkbox label="疑问"></el-checkbox>
                                            <el-checkbox label="重大"></el-checkbox>
                                            <el-checkbox label="紧急"></el-checkbox>
                                            <el-checkbox label="维稳"></el-checkbox>
                                            <el-checkbox label="特定"></el-checkbox>
                                            <el-checkbox label="指定"></el-checkbox>
                                            <el-checkbox label="拨测"></el-checkbox>
                                        </el-checkbox-group>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="16">
...
<!--                        </el-button>-->
            ...
            <el-tab-pane label="分派" v-if="assign">
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    <el-row style="margin: 20px 0;">
                        <el-col :xs="24" :sm="24" :md="24" :lg="12">
                            <el-form-item label="成员单位：" prop="department" label-width="115px" required>
                                <el-select v-model="nextStepForm.department" placeholder="请选择" prop="department" style="width: 115px;">
                                    <el-option
                                            v-for="item in dept"
                                            :key="item.value"
                                            :label="item.label"
                    ...
                    <el-row style="margin: 20px 0;">
                        <el-col style="text-align: right;width: 98%;">
...
<!--                            <el-form-item label="是否受理：" prop="opinion" label-width="105px">-->
<!--                                <el-select v-model="nextStepForm.opinions" placeholder="默认意见" style="width: 160px;">-->
<!--                                    <el-option-->
<!--                                            v-for="item in accepts"-->
<!--                                            :key="item.value"-->
<!--                                            :label="item.label"-->
<!--                                            :value="item.value">-->
<!--                                    </el-option>-->
...
<!--                        </el-col>-->
                        <el-col :xs="24" :sm="24" :md="24" :lg="12">
                            <el-form-item label="受理方式：" prop="department" label-width="105px" required>
                                <el-select v-model="nextStepForm.department" placeholder="请选择" prop="department" style="width: 250px;">
                                    <el-option
                                            v-for="item in dept"
                                            :key="item.value"
                                            :label="item.label"
...
<!--                    <table style="width: 96%;border-color: #fbfdff;margin: 0 auto;margin-top: 15px" cellspacing="0" cellpadding="0" border>-->
<!--                        <tr style="width: 100%;height: 65px;">-->
<!--                            <td  style="width: 20%;height:120px;text-align: center;font-weight: bold;"><span style="color: #e64242">*</span>意见：</td>-->
<!--                            <td  style="width: 80%">-->
<!--                                <input style="width: 99.5%;height: 120px;" placeholder="请输入内容">-->
<!--                            </td>-->
<!--                        </tr>-->
...
<!--                        <el-col :xs="12" :sm="12" :md="12" :lg="6">-->
<!--                            <el-form-item label="是否受理：" prop="opinion" label-width="105px">-->
<!--                                <el-select v-model="nextStepForm.opinion" placeholder="默认意见" style="width: 160px;">-->
<!--                                    <el-option-->
<!--                                            v-for="item in notAccept"-->
<!--                                            :key="item.value"-->
<!--                                            :label="item.label"-->
<!--                                            :value="item.value">-->
<!--                                    </el-option>-->
...
<!--                        </el-col>-->
                        <el-col :xs="24" :sm="24" :md="24" :lg="12">
                            <el-form-item label="不受理原因：" prop="department" label-width="130px" required>
                    ...
                    <table style="width: 96%;border-color: #fbfdff;margin: 0 auto;margin-top: 15px" cellspacing="0" cellpadding="0" border>
                        <tr style="width: 100%;height: 65px;">
                            <td  style="width: 20%;height:120px;text-align: center;font-weight: bold;"><span style="color: #e64242">*</span>不受理内容：</td>
                            <td  style="width: 80%">
                                <input style="width: 99.5%;height: 120px;" placeholder="请输入内容">
                            </td>
                        </tr>
            ...
            <el-tab-pane label="退回" v-if="back">
                <el-form :model="nextStepForm" ref="nextStepForm" style="width: 96%;margin: 0 auto">
                    <el-row style="margin: 20px 0;">
                        <el-col :xs="24" :sm="24" :md="24" :lg="12">
                            <el-form-item label="退回原因：" prop="opinion" label-width="105px">
                                <el-select v-model="nextStepForm.opinion" placeholder="请选择" style="width: 160px;">
                                    <el-option
