<template>
    <section class="backLog">
        ...
        <el-tabs type="border-card" style="width: 96%;margin: 0 auto;min-height: 420px;">
            ...
            <el-tab-pane label="下一步">
                ...
                <el-form :model="nextStepForm" ref="nextStepForm">
                    <el-row style="margin: 20px 0 0 0;">
                        ...
                        <el-col style="text-align: right;width: 100%;">
                            <el-button type="primary" @click="$router.push('/wddb/tsldb/qtsl')">
                                发送
                            </el-button>
                        </el-col>
                    </el-row>
