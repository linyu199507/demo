<template>
    <section class="examine">
        ...
        <table style="width: 96%;margin: 0 auto;border-color: #fbfdff;" cellspacing="0" cellpadding="0" border v-show="flows">
            ...
            <tr style="width: 100%;height: 65px;">
                ...
                <td style="width: 80%">
                    <input style="width: 99.5%;height: 120px;" v-model="value6" placeholder="请输入内容">
                </td>
            </tr>
        </table>
        <el-col style="height: 15px;"></el-col>
        ...
        <el-col style="text-align: right;width: 98%;" v-show="flows">
            <el-button type="primary" @click="nextStep">
                <router-link to="/wddb/zfldb/tssp" style="color: #fff;text-decoration: none;">发送</router-link>
            </el-button>
        </el-col>
    </section>
</template>
