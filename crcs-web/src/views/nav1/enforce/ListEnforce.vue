<template>
    <section>
        ...
        >
            ...
            <el-table-column prop="on" label="登记编号" width="160"  sortable align="center"></el-table-column>
            <el-table-column prop="subject" label="涉及主体名称" min-width="180" sortable align="center"
                             show-overflow-tooltip></el-table-column>
            <el-table-column prop="content" label="登记内容" min-width="180" sortable align="center"
                             show-overflow-tooltip></el-table-column>
            <el-table-column prop="birth" label="登记日期" width="150" sortable align="center"></el-table-column>
            <el-table-column prop="provider" label="提供方" width="100" sortable align="center"></el-table-column>
            <el-table-column prop="type" label="类型" width="100" :formatter="formatType" sortable align="center">
            </el-table-column>
        </el-table>
        <br/>
        <!--分页组件开始-->
        ...
        methods: {
            ...
            toFind(row, column) {
                ...
                if (column.property !== 'select') {
                    this.$router.push('/wddb/zfldb/zfsl')
                }
            },
