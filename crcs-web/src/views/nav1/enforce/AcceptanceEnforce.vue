<template>
    <section class="backLog">
        ...
        <el-tabs type="border-card" style="width: 96%;margin: 0 auto;min-height: 400px;">
                    ...
                    <el-row>
                        ...
                        <el-col :xs="24" :sm="24" :md="24" :lg="24">
                            <el-form-item label="投诉内容:">
                                <el-input
                                        style="color: #1f2d3d;font-size: inherit;"
                                        type="textarea"
            ...
            <el-tab-pane label="下一步">
                ...
                <el-col style="text-align: right;">
                    <el-button type="primary" @click="nextStep">
                        <router-link to="/wddb/zfldb/qtsl" style="color: #fff;text-decoration: none;">发送</router-link>
                    </el-button>
                </el-col>
            </el-tab-pane>
        </el-tabs>
