<template>
    <section class="leaderExamine">
        ...
        <el-col style="padding: 3px 15px;width: 94%;margin: 0 auto; margin-left: 120px;">
                    ...
                    <el-row>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item label="核查名称:">
                                <el-input v-model="mainForm.verification" placeholder="请输入" class="input-text"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
        ...
        <el-col style="height: 15px;"></el-col>
        <table style="width: 96%;margin: 0 auto; border-color: #fbfdff;" cellspacing="0" cellpadding="0" border
               v-show="flows">
            <tr style="width: 100%;background-color: #ececec;">
                <th colspan="4">历次意见</th>
            </tr>
            ...
            <tr style="width: 100%;height: 65px;">
                <td style="width: 20%;text-align: center;background-color: aliceblue;">受理意见：</td>
                <!--                <td  style="width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp;同意受理</td>-->
            ...
            <tr style="width: 100%;height: 65px;">
                <td style="width: 20%;text-align: center;"><span style="color: #e64242">*</span>意见：</td>
                <td style="width: 80%">
                    <input style="width: 100%;height: 120px;" v-model="form.neiron" placeholder="请输入内容">
                </td>
            </tr>
        </table>
        <!--        <el-col style="height: 15px;"></el-col>-->
        ...
        <el-col style="text-align: right;width: 98%;" v-show="flows">
            <el-button type="primary" @click="nextStep">
                <router-link to="/wddb/tsldb_temp/cljg" style="color: #fff;text-decoration: none;">发送</router-link>
            </el-button>
        </el-col>
    </section>
</template>
