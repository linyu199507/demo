<template>
  <section class="leadership_audit" id="whole">
    <el-tabs
      type="border-card"
    ...
    >
      <el-row v-if="ismain && aictabs ==0 ">
        <el-col style="text-align: right; " :class="{'fixed':scrollTop>height}">
          <el-button type="primary" @click="toReview('true')">审核通过</el-button>
          <el-button type="primary" @click="toReview('false')">审核不通过</el-button>
        </el-col>
      </el-row>
              ...
              <el-row>
                <el-col :xs="24" :sm="24" :md="24" :lg="24">
                  <el-form-item label="请选择区局处理人" prop="leader" class="form_bt">
                    <el-select v-model="reviewForm.leader" placeholder="请选择">
                      <el-option
...
<script>
import { next, searchBaseInfo, findUsersByPermission,selectBaseCodeTree } from "../../../api/api";
