    ...
    <section class="accraditation">
        ...
        <table v-show="flows" style="width: 96%;margin: 0 auto;border-color: #fbfdff;" cellspacing="0" cellpadding="0" border>
            ...
            <tr style="width: 100%;height: 65px;">
                ...
                <td  style="width: 80%"><input style="width: 99.5%;height: 120px;" placeholder="请输入内容"></td>
            </tr>
        </table>
        <!--        <el-col style="height: 15px;"></el-col>-->
        <!--        <el-col>-->
        ...
        <el-col :span="19" v-show="flows" style="margin: 0 26px;">
            ...
            <el-col :span="3" style="padding: 3px 37px;"><span style="color: #e64242">*</span>日期：</el-col>
            <el-col :span="4">
                <el-date-picker type="date" placeholder="选择日期" v-model="form.date1" style="width: 100%;"></el-date-picker>
            </el-col>
            <el-col :span="5" style="padding: 3px 28px;"><span style="color: #e64242">*</span>选择下一步处理部门：</el-col>
            <el-col :span="4">
        ...
        <el-col style="text-align: right;width: 98%;" v-show="flows">
            <el-button type="primary" @click="nextStep">
                <router-link to="/wddb/zxldb/tssc" style="color: #fff;text-decoration: none;">发送</router-link>
            </el-button>
        </el-col>
    </section>
</template>
