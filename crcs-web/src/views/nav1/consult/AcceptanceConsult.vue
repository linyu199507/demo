<template>
    <section class="backLog">
        <!--        <el-col style="height: 55px;"></el-col>-->
        ...
        <el-tabs type="border-card" style="width: 96%;margin: 0 auto;">
                    ...
                    <el-row>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item label="法定代表人:">
                                <el-input v-model="entForm.representative" placeholder="请输入"
            ...
            <el-tab-pane label="下一步">
                <table style="border-color: #fbfdff;width: 100%;" cellspacing="0" cellpadding="0" border>
                ...
                <el-col style="text-align: right;width: 100%;">
                    <el-button type="primary" @click="nextStep">
                        <router-link to="/wddb/zxldb/qtsl" style="color: #fff;text-decoration: none;">发送</router-link>
                    </el-button>
                </el-col>
            </el-tab-pane>
        </el-tabs>
