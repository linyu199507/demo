    ...
    <section class="sldej">
        ...
        >
            ...
            <el-table-column
                    ...
                    :formatter="formtypes"
            ></el-table-column>
            <el-table-column prop="tserialnum" label="工单号" min-width="17%" align="center">
            ...
            <el-table-column prop="complainanted" label="涉及主体名称" min-width="12%" align="center" show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods: {
                ...
                tableRowClassName(item) {
                    //console.log(item)
                    if(item.ismain === "0" && item.nextnodeid != "collaborative"){
                        // item.tserialnum = item.tserialnum + "(抄送)"
                        return 'coloer_change';
                    }else{
                        return '';
                    }
                },
            ...
            setSerialnumRed(row) {
                if (row.ismain === "0" && row.nextnodeid != "collaborative") {
                    return row.tserialnum + ' (抄送)';
                } else {
            ...
            toFind(column, row) {
                ...
                if ("0" === row.ismain || "collaborative" == row.nextnodeid) {
                    //抄送部门工单处理
            ...
            formatDate(row, column) {
                return moment(row.assigndate).format("YYYY-MM-DD HH:mm:ss");
            },
            //时间转换
