            ...
            <el-row>
                <el-col :xs="24" :sm="24" :md="{span:16,offset:4}" :lg="{span:14,offset:4}">
                   ...
                   <!-- <el-form-item label="确认密码" prop="checkpassword">
                        <el-input type="password" v-model="basecodeform.checkpassword" placeholder="请输入确认密码" class="input-text"></el-input>
                    </el-form-item>-->
                </el-col>
...
<script>
    import {addBasicData} from '../../api/api';
    ...
    export default {
        ...
        methods: {
            submitForm() {
                ...
                let para = {
                    ...
                    type:this.basecodeform.type,   //类型
                    codeid:this.basecodeform.codeid, //ID
                    comment:this.basecodeform.comment, //名称
                    parentid:this.basecodeform.parentid ,//父级ID
                    orglevel:this.basecodeform.orglevel
                    // parentid:this.$route.query.parentid //父级ID

                };
                console.log(para)
                addBasicData(para).then((res) =>  {
                    console.log(res)
                    if (res.code === 0) {
                        this.$alert('数据添加成功！', '提示', {
                            type: 'success',
        ...
        mounted() {
            ...
            this.basecodeform.type = type;
            // console.log(this.basecodeform.type)
        }
    }
</script>
