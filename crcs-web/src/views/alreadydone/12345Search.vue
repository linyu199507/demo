<template>
    <div>
                    ...
                    <el-col :xs="24" :sm="24" :md="8" :lg="8">
                        <el-form-item label="工单类型：">
                            ...
                            <el-select v-model="searchForm.bustype"
                                ...
                                <el-option label="举报类" value="举报类"></el-option>
        ...
        >
            ...
            <el-table-column prop="bustype" label="业务类型" min-width="4%" align="center"></el-table-column>
            <el-table-column prop="serialnum" label="表单号" min-width="10%" align="center"></el-table-column>
            <el-table-column prop="tserialnum" label="工单号" min-width="10%" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            // getScroll() {
            //   this.scrollTop =  document.getElementById("whole").scrollTop;
            ...
            gotoDeal(scope, row) {
                ...
                let url = this.$router.resolve({
                    path: "/tjfx/zhcx/cqjlcx/12345lists/ywjlxq",
                    query: params
                });
                window.open(url.href, "_blank")
                // this.$router.push({path:'/tjfx/zhcx/cqjlcx/12345lists/ywjlxq',query:params})
            },
