  ...
  <div>
      ...
      <el-form label-width="120px">
        <el-col :xs="24" :sm="24" :md="12" :lg="12">
          <el-form-item label="登记编号：">
            <el-input @change="getSearchList" placeholder="请输入登记编号" v-model="searchForm.number" style="width:200px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :md="12" :lg="12">
    ...
    >
      ...
      <el-table-column
        ...
        show-overflow-tooltip
      ></el-table-column>
      <el-table-column prop="handledeptname" label="处理部门" min-width="8%" align="center"></el-table-column>
      <el-table-column
