        ...
        >
            <el-tab-pane :label="formTypeStr" name="tabMainContent">
                ...
                >
                    ...
                    <!--                    <el-button v-if="this.formType==='complaintmodule' || this.formType==='comeconomicmodule'"-->
                    <!--                               type="primary" @click="triggerTab('tabExtension')">申请延期-->
                    <!--                    </el-button>-->
                    <el-button
                            type="primary"
                            @click="triggerTab('tabBack')"
                            v-if="user.unitID == 'da00ef72-5b56-4f5b-88c2-4b038a7f41a0'"
                    >退回
                    </el-button>
                </div>
                    ...
                    <el-collapse-item name="orderInfo">
                        <div slot="title" @click.stop>
                            <el-row class="el-accordion title_accordion">
                                ...
                                ><!--工单号：{{tasklist.tserialnum}}--></el-col>
                            </el-row>
                        </div>
                        <!-- 12315消费投诉 -->
                    ...
                    >
                      ...
                      ></el-cascader>
                                    ...
                                    <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                        <el-form-item label="赔偿方式：" prop="compensateMode" class="bt">
                                            <el-input
                                                    placeholder="请输入赔偿方式"
                                                    v-model="caseprocesform.compensateMode"
                                                    class="input-text"
                                            ></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <el-form-item label="证据：" prop="evidence" class="bt">
                                            <el-select v-model="caseprocesform.evidence" class="input-text">
                                                <el-option label="发票" value="1"></el-option>
                                                <el-option label="收据" value="2"></el-option>
                                                <el-option label="收银小票" value="3"></el-option>
                                                <el-option label="录音" value="4"></el-option>
                                                <el-option label="录像" value="5"></el-option>
                                                <el-option label="证人" value="6"></el-option>
                        ...
                        <el-collapse-item name="3">
                            ...
                            >
                                <el-row>
                                    ...
                                    <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                        <el-form-item label="经办人：" prop="operator" class="bt"
                                                      v-if="user.regionID === '440681'">
                                            <el-input v-model="caseprocesform.operator"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                        <el-form-item label="经办人电话：" prop="operatorPhone" class="bt"
                                                      v-if="user.regionID === '440681'">
                        ...
                        <el-row style="margin: 20px 0;">
                            <el-col style="text-align: center;width: 100%;">
                                ...
                                <el-button type="primary" @click="openRegionAudit('caseprocesformRules')"
...
<script>
    ...
    import {getMaterialLists, uploadFile,sendMessage,
        getSMSPerson} from "../../api/api";
    ...
    export default {
        ...
        data() {
            return {
                ...
                registercase: false,
                caseprocesform: {
                    operator: "佛山市顺德区市场监督管理局",
                    operatorPhone: "22838180",
                    noobligationnew: "",
                    id: "",
                    caseguid: "",
                    nodeid: "",
                ...
                caseprocesformRules: {
                    ...
                    mediationmethodscodeid: [{required: true, message: "请选择调解方式"}],
                    ...
                    disputemoney: [
                        ...
                        {max: 9999,message:"争议金额大于9999元",trigger:"blur",type: "number"},
                        {
        ...
        doublemoney: [
          { required: true, type: "integer", message: "请输入金额" }
                    ...
                    handleopinion: [
                        ...
                        {max: 1000, message: "不能超出3000字符", trigger: "blur"}
                    ],
            ...
            triggerTab(value) {
                ...
                if (this.complaintform != null && this.complaintform != "") {
                    (this.caseprocesform.subjectname = this.complaintform.subjectname),
                        (this.caseprocesform.semakbusinessaddress = this.complaintform.cksubjectaddress);
                    this.caseprocesform.semaknama = this.complaintform.cksubjectname;
                    this.caseprocesform.businessaddress = this.complaintform.subjectaddress;
                    this.caseprocesform.subjecttypecodeid = this.complaintform.providetypecodeid;
            ...
            openRegionAudit() {
                ...
                if (this.user.unitID == 'da00ef72-5b56-4f5b-88c2-4b038a7f41a0') {
                    this.$confirm("请确认无误提交?", "提示", {
                        ...
                        let data = JSON.parse(JSON.stringify(this.caseprocesform));
                        //转换数组
                        for (let key in data) {
                ...
                searchBaseInfo({id, caseguid, systemsource: "03"})
                    .then(({code, data}) => {
                        ...
                        if (data.caseprocesform != null) {
                            ...
                            if (this.caseprocesform.transferreddate != null || this.caseprocesform.transferreddate != "") {
                                this.caseprocesform.transferreddate = ""
                            }
                        }
                        this.caseprocesform.handleDepart = "业务部门";
                        this.caseprocesform.leadershipAudit = "1";
                        this.caseprocesform.postscript = "请领导审批";
