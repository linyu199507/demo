...
<script>
    import {searchBaseInfo, nextWork, findUsersByPermission, selectBaseCodeTree,selectDataList,getMaterialLists} from "../../api/convenient12315";
    ...
    export default {
        ...
        methods: {
            ...
            leaderChange() {
                ...
                //     caseprocesform:this.caseprocesform
                // }
                // selectDataList(param).then(res => {
                //     console.log(res)
                //     this.caseprocesform = res.data.caseprocesform;


                /*if(this.caseprocesform.subjecttype != null && this.caseprocesform.subjecttype != ""){
                    this.caseprocesform.subjecttype=this.caseprocesform.subjecttype.split()
                }
                if(this.caseprocesform.infringementtype != null && this.caseprocesform.infringementtype != ""){
                    this.caseprocesform.infringementtype=this.caseprocesform.infringementtype.split()
                }
                if(this.caseprocesform.infringingmarks != null && this.caseprocesform.infringingmarks != ""){
                    this.caseprocesform.infringingmarks=this.caseprocesform.infringingmarks.split()
                }
                if(this.caseprocesform.mediationmethods != null && this.caseprocesform.mediationmethods != ""){
                    this.caseprocesform.mediationmethods=this.caseprocesform.mediationmethods.split()
                }
                if(this.caseprocesform.noobligation != null && this.caseprocesform.noobligation != ""){
                    this.caseprocesform.noobligation=this.caseprocesform.noobligation.split()
                }*/
