        ...
        <ul>
                  ...
                  <div class="content">
                    <ul>
                      ...
                      <li>
                        ...
                        <div class="Procontent">意见建议及其他政务问题-其他政务问题</div>
                      </li>
                      <li>
                        <div class="Protitle">标题:</div>
                        <div class="Procontent">沙发消费问题</div>
                      </li>
                      <li>
          ...
          <li v-show="nowIndex == 3">
            <flow
              ...
              :style="`height:${6.3*flowList.length}rem`"
              class="mb100 mt100"
            >
...
export default {
  ...
  mounted() {
    this.caseguid = this.$route.query.id;
