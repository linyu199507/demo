    ...
    <div class="main-container">
        <card :header="{title: '1、提供方信息'}">
            <div slot="content" class="card-box">
                ...
                <p>
                    <span class="detail-item" style="width:30%">区域：{{data.region}}</span>
                ...
                <p>
                    ...
                    <span class="detail-item" style="width:70%">来电号码：{{data.rqstnumber}}</span>
                </p>
                <p>
                    <span class="detail-item" style="width:70%">联系电话：{{data.linknumber}}</span>
                ...
                <p>
                    ...
                    <span class="detail-item" style="width:25%">工单分类：{{data.focus}}</span>
                </p>
                <p>
        ...
        <card :header="{title: '2、涉及主体信息'}">
            <div slot="content" class="card-box">
                ...
                <p>
                    ...
                    <span class="detail-item" style="width:50%">联系方式：{{data.subjectphone}}</span>
                </p>
                <p>
                    <span class="detail-item" style="width:100%">经营地址：{{data.subjectaddress}}</span>
                </p>
            </div>
        </card>
        <card :header="{title: '3、涉及客体信息'}">
            <div slot="content" class="card-box">
                ...
                <p>
                    <span class="detail-item" style="width:45%">涉及金额：{{data.objmoney}}元</span>
                    <span class="detail-item" style="width:50%">商品/服务价格：{{data.price}}元</span>
                </p>
                <p>
        ...
        <card :header="{title: '4、业务具体信息'}">
            <div slot="content" class="card-box">
                <p>
                    <span class="detail-item" style="width:45%">涉及问题分类：{{data.complaintstype}}</span>
                ...
                <p>
                    <span class="detail-item" style="width:45%">事件级别：{{data.eventlevel}}</span>
                    <span class="detail-item" style="width:50%">政务标签：{{data.govlabeloutput}}</span>
                </p>
            </div>
        </card>
        <card :header="{title: '处理相关信息'}">
            <div slot="content" class="card-box">
                <p>
                    <span class="detail-item" style="width:100%">投诉要求：{{data.report}}</span>
                </p>
                <p>
                    <span class="detail-item" style="width:100%">是否出现场：{{data.isoutmall}}</span>
                </p>
            </div>
        </card>
    </div>
